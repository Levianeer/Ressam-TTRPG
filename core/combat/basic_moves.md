Basic Moves are the simple, universal actions everyone can take on their turn - proactively setting up an exchange, rather than the reactive Oppose (see [[Oppose|maneuvers]]) that answers one.
...
**Action:** Minor  
**Effect:** Move the shared measure between you and one engaged opponent one Measure Band, in or out (see [[Measure Bands|weapons]] and [[Reach|positioning]]) - this includes whatever movement the shift requires, up to your speed. No check required. Shifting into a band your opponent's weapon still matches provokes their Opportunity Attack, the same as any other close to melee (see [[Opportunity Attacks|positioning]]).
