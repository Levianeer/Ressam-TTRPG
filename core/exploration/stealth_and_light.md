...
**Turns:** A Turn is 10 minutes, the standard unit of dungeon/site exploration (see [[Dungeon Turns|dungeon_turns]]). Light durations above are tracked on one shared party tracker, not per character - see Dungeon Turns' Light Tracker for how that tally is kept during a delve. **Optional Rule:** groups who prefer real-time light tracking may instead treat these durations as 1 hour (Candle), 2 hours (Torch), and 12 hours per flask (Lantern) \- but this abandons the shared-tracker/wandering-encounter tie-in.
