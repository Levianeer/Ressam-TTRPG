This section covers everything your character might need beyond weapons and armor \- from basic survival gear to specialized professional tools. Smart adventurers invest in quality equipment; the right tool at the right time can save your life.

**Improvised Efforts:** When you lack the proper tools for a skill check, take a -4 penalty to reflect the crude edge of desperation. If tools are merely advantageous (such as using a rock in place of a hammer), reduce to -2; if they are utterly essential (lockpicks for a lock, or a surgeon's kit for delicate wounds), increase to -6.

---

## Currency

The world uses three major currencies, each dominant in different regions.
...
- Crowns are the gold standard, used almost everywhere, but it’s usually wiser to use the local currency when you can.  
- Money changers charge 5-10% commission  
- Remote areas may only accept local currency
...
Tactical equipment for combat preparation and area control. These items give martial characters tools to shape the battlefield before and during combat.
...
**Common Clothes:** mark you as a peasant or laborer \- invisible to nobles, non-threatening to guards, out of place at court.

**Fine Clothes:** suggest wealth and education. Merchants, minor nobles, and professionals wear these. You'll be served faster at inns and taken seriously by officials \- but also targeted by thieves.

### **Context matters**

A noble in common clothes draws suspicion. A peasant in fine clothes draws more. Dress for where you're going, not where you've been.
...
Having appropriate tools grants **advantage** on related skill checks (DM discretion).
