...
- **Reactive** → Damage/Toxins: **0/+1/+2**  
- **Protective** → Resistance/Armor: **0/+1/+2**  
- **Sensory** → Perception/Clarity: **0/+1/+2**

### **Powders**

- **Amplifying** → Increases Effect Bonus for potions with Dice: **0/+1/+2**  
...
- **Effect:** Thrown (20/40 ft), 15 ft radius of obscuring smoke. Blocks line of sight beyond 5 ft  
  - **Common:** 1 minute duration  
  - **Uncommon:** 2 minutes duration  
...
- **Effect:** Drink (Minor Action). Advantage on Perception checks  
  - **Common:** **5 × Bonus** minutes duration  
  - **Uncommon:** **10 × Bonus** minutes duration  
...
- **Effect:** Apply (Minor Action). Cannot be surprised. \+2 to initiative rolls  
  ...
  - **Uncommon: 2 \+ Bonus** hours duration  
  - **Rare:** **3 \+ Bonus** hours duration  
- **Value:** 40 Crown (Common), 60 Crown (Uncommon), 100 Crown (Rare)
