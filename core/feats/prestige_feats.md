Prestige Feats represent fundamental transformations in how a character interacts with the world. They are not simply powerful \- they are different. Taking a Prestige Feat means accepting a new way of existing, often with costs as meaningful as the benefits.

**Requirements:**

- Character must be Level 5\.
- Must meet the listed Skill and Attribute prerequisites.
  - This can be done *after* all other Level 5 Skill/Attribute changes.
  - The ritual is required for the Feat to ‘do anything’.
- Must complete the narrative ritual described.
  - DM discretion on specifics, the example rituals are guides, not hard rules.

**Restrictions:**

- You may only have ONE Prestige Feat.
- Prestige Feats can be unlearned with extraordinary circumstances.
  - Pick a replacement non-Prestige Feat.
  - DM discretion on specifics.
...
**Prerequisites:** STR 4+, \+3 ranks in Athletics, \+2 ranks in any STR weapon Skill
...
- You cannot make weapon attacks with a Fencing Blades weapon, and can no longer fund your Oppose roll with a Weapon Skill.
...
**Prerequisites:** DEX 4+, \+3 ranks in Perception or Insight, \+2 ranks in any STR or DEX weapon Skill
...
**Effect:** You no longer roll initiative. You have no initiative score. You act last in every round, after all other creatures have completed their turns. You can no longer swap initiative with another.

**Mechanical Changes:**

- Once per round, when a creature takes any action, you may use your Reaction to interrupt \- taking your turn immediately (instead of at the end of the round). The triggering action is delayed until after your turn completes.
- You cannot be surprised, but you cannot benefit from surprise rounds (you observe, but do not act during them).
...
**Prerequisites:** STR 4+, \+2 ranks in any Arcane or Divine school Skill, \+2 ranks in a Lore Skill
...
**Prerequisites:** DEX 4+, \+3 ranks in Acrobatics, \+2 ranks in Subterfuge
...
**Effect:** In combat, you lose the normal Move action. Your only way to change position is **Slip** OR **Move** *at half your movement speed*.

**Slip:**

- Usable once per turn (no action cost).
- Instantly relocate to any unoccupied space you can see within a distance equal to your current movement speed (including racial bonuses, Feline Agility, temporary speed buffs, etc.).
- This movement:
  - Does not provoke opportunity attacks.
  - Does not count as teleportation.

**Pathing Restriction:** You can only Slip to a space you could reach with normal movement. You cannot pass through walls, barriers, creatures' spaces, or other impassable obstacles; you cannot change elevation without a valid climbing or jumping path. Slip removes the physical act of traversal \- not the limitations of the path itself.

**Dash Interaction:** If you take the Dash action as a Major Action, you gain one additional Slip that turn (maximum two Slips per turn).

**Mechanical Changes:**

- You cannot wear armor that would induce any Armor Penalty (after Broken In reduction, if taken).
...
**Prerequisites:** MIND 4+, \+2 ranks in any Arcane or Divine school Skill, \+2 ranks in Arcane Lore or Religious Lore
...
**Effect:** When you take damage, you may spend a Reaction and expend Mana or spell scrolls to reduce that damage by 2 for each point of Mana spent, or each point of Mana Cost from a consumed scroll.

**Mechanical Changes:**

- You may split the reduction between Mana and scrolls in any combination.
...
- Scrolls consumed this way are destroyed without casting their spell.
...
**Prerequisites:** ARC 4+, \+3 ranks in any Arcane school Skill, \+2 ranks in Crafting
...
- Your brands glow faintly when you cast or take damage. You have disadvantage on Subterfuge checks to conceal your nature as a spellcaster.
...
**Prerequisites:** FAI 4+, \+3 ranks in any Divine school Skill, \+2 ranks in Religious Lore
...
**Prerequisites:** CHA 4+, \+2 ranks in any CHA skill, \+2 ranks in any STR or DEX weapon Skill
...
**Effect:** Choose one weapon you own. It is now bound to your soul. You use CHA for damage rolls with this weapon, instead of STR or DEX (Attack Rolls are Skill-only and unaffected by this swap - core_rules.md's Skill Check Formula).

**Mechanical Changes:**

- You may recall the bound weapon to your hand from up to 240 ft as a Minor Action.
- If the weapon is destroyed, or remains beyond 240 ft for longer than 24 hours, you take damage equal to your CHA \+ the skill you use for the weapon. This damage repeats daily until the weapon is restored or replaced through a new binding ritual.
- You cannot bind a new weapon while your current weapon exists and is within range.
- Binding a new weapon requires repeating the full ritual.
