This page is a reference glossary: what each Attribute represents and what each Skill actually covers at the table. For the mechanics that use these numbers - the Skill Check formula, the DC tier table, Wards, and Contested Checks - see [[Core Rules|core_rules]]. For how many points you have to spend on each and when, see [[Character Creation|character_creation]] and [[Per Level Advancement|progression_&_rewards]].
...
**Automatic Literacy:** A character with **MIND 3+** at character creation is literate, able to read and write every language they know. Certain Careers (see [[Careers|careers]]) grant literacy as well, regardless of MIND. Below MIND 3, a character is illiterate by default unless literacy is granted by Career - see [[Core Rules|core_rules]] for the full rules, including learning to read later in play. Spellcasting requires literacy: an illiterate character cannot invest in an Arcane or Divine school, regardless of ARC or FAI, until they learn to read.

---

## Skills

Skills range from 0 (untrained) to 5 (renowned master). Each is tied to one governing Attribute and rolls as **1d12 \+ Skill Ranks** vs. a DC (see the Skill Check Formula and DC tier table in [[Core Rules|core_rules]]).
...
**See Also:** [[Core Rules|core_rules]] for the Skill Check Formula, DC tier table, and Checks vs. Ward; [[Character Creation|character_creation]] for how Attribute and Skill points are allocated; [[Per Level Advancement|progression_&_rewards]] for how they grow after level 1.